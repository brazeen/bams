...
const panelClassName =
  'col-start-1 row-start-1 flex w-full bg-white p-4  text-sm text-neutral-950 outline-none focus-visible:z-1 focus-visible:outline-2 focus-visible:outline-solid focus-visible:-outline-offset-1 focus-visible:outline-neutral-950 dark:focus-visible:outline-white dark:bg-neutral-950 dark:text-white [[hidden]]:hidden';
...
export default function PageTabs() {
  return (
    <Tabs.Root className="w-full h-full" defaultValue="overview">
      ...
      <div className="grid w-full min-h-full grid-cols-1 border border-neutral-950 dark:border-white">
